  ...
  return (
    <div className="mt-8">
      ...
      {<div className="absolute mt-[75px] min-[400px]:mt-24 flex">
        <img className="relative ml-3 h-[250px] w-[175px] min-[400px]:w-[215px] min-[400px]:h-[320px] rounded-2xl" 
        src="src/assets/layer-card-test.png" alt="" />
        <img className="relative ml-3 h-[250px] w-[175px] min-[400px]:w-[215px] min-[400px]:h-[320px] rounded-2xl" 
        src="src/assets/layer-card-test.png" alt="" />
      </div>}

      <div className="absolute mt-80 pt-5 min-[400px]:pt-28 min-[400px]:pl-20 ml-80 flex"> 
